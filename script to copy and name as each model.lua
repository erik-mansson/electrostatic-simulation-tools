...
--     _G.U={-100,-100*0.7,-200}; _G.U[0]=0; U=_G.U; adjustable DoNotSetPotentials=-1;
-- 
...
adjustable _U_Bfirst  = -1000 -- The potential [V] applied to electrode 1 (most distant from detector)
adjustable _U_Afirst  = -1000 -- The potential [V] applied to electrode 8 (the separating mesh). (Ignored if R_control_8==0)
adjustable _U_Bfree = -1000 -- The potential [V] applied to electrode _free_index (main Einzel lens electrode on A-side, isolated from other electrodes)
...
adjustable _U_Blast = -1000 -- The potential [V] applied to electrode B_LAST (closest to phosphorescent screen).
...
adjustable _U_BMCP = -1000   -- Potential [V] at the "B"-MCP front 
...
function segment.initialize()
  if has_shown_potentials == 0 then -- only first time
    ...
    if DoNotSetPotentials == 0 then
      ...
      if math.abs(U[B_LAST] - _U_Blast) > 1e-5 then
